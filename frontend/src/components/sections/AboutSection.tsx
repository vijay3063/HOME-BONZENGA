      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            We are dedicated to creating exceptional web experiences that combine cutting-edge technology 
            with thoughtful design. Every project is an opportunity to push boundaries and deliver excellence.
          </p>
        </div>
