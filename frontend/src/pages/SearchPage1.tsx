...
const SearchPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#fdf6f0]">
      ...
      {/* CTA Section - Become a Beautician */}
      <section className="py-20 bg-[#4e342e] text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <div className="inline-flex items-center bg-white/20 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-sm font-medium font-sans">Join Our Network</span>
            </div>
            ...
            <p className="text-xl text-white/90 mb-8 font-sans leading-relaxed">
              Join our platform and grow your beauty business with verified clients across Congo
            </p>
