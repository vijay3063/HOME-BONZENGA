...
const ManagersPage = () => {
  ...
  const fetchManagers = async () => {
    try {
      ...
      const response = await fetch('http://localhost:3001/api/admin/managers', {
        headers: {
      ...
      if (response.ok) {
        ...
        const mockManagers: Manager[] = [
          ...
          },
          {
            ...
            lastLoginAt: '2024-12-20T14:20:00Z',
            isVerified: true,
            stats: {
              vendorsApproved: 8,
              vendorsRejected: 2,
              appointmentsManaged: 45,
              totalActions: 55
            }
          },
          {
